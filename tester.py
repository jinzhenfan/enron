...
def test_classifier(clf, dataset, feature_list, folds = 100):
    ...
    try:
        ...
        evaluation=[true_positives,false_positives,true_negatives,false_negatives]
        print (clf)
...
def main():
    ...
    ### Run testing script
    evaluation=test_classifier(clf, dataset, feature_list)
    print(evaluation)
    bar_chart(("true_positives","false_positives","true_negatives",\
